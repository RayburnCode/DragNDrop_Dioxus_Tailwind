use dioxus::prelude::*;
use super::{BlockItem, BlocksPanel, StylingPanel, PagesLayersPanel, AssetPanel};
            ...
            div { class: "w-16 bg-white border-r border-gray-200 flex flex-col",
                ...
                nav { class: "flex-1 overflow-y-auto py-4 space-y-2 flex flex-col items-center",
                    ...
                    button {
                        class: {
                            let base = "p-2 rounded-lg text-gray-700 hover:bg-gray-100";
                            if active_section() == NavSection::Styling {
                                format!("{base} bg-blue-50 text-blue-600")
                            } else {
                                base.to_string()
                            }
                        ...
                        onclick: move |_| {
                            active_section.set(NavSection::Styling);
                            is_drawer_open.set(true);
                        },
                        title: "Styling",
                        svg {
                    ...
                    button {
                        class: {
                            let base = "p-2 rounded-lg text-gray-700 hover:bg-gray-100";
                            if active_section() == NavSection::Assets {
                                format!("{base} bg-blue-50 text-blue-600")
                            } else {
                                base.to_string()
                            }
                        ...
                        onclick: move |_| {
                            active_section.set(NavSection::Assets);
                            is_drawer_open.set(true);
                        },
                        title: "Assets",
                        svg {
